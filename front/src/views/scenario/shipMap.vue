...
} from "../../utils/geoscratch/function/tbvs";
...
export default {
  ...
  setup() {
    onMounted(async () => {
      ...
      const shipData = await axios
        .get("http://172.21.212.254:8002/ship/QueryCode", {
      ...
      for (let i = 0; i < shipNum; i++) {
        ...
        aisPoints.push(
          new tbvsSymbol(0, style[0], style[1], [
            positionX[0],
            positionY[0],
            positionX[1],
            positionY[1],
