...
export class FlowFieldManager {
    ...
    async Prepare(gl: WebGL2RenderingContext, ) {
        ...
        // Build Shaders
        this.updateShader = await loadShader_url(gl, "update", "./flow/shaders/update.vert", "./flow/shaders/update.frag", ['newPosition', 'aliveTime']);
        this.drawShader = await loadShader_url(gl, "draw", "./flow/shaders/ribbonParticle.vert", "./flow/shaders/ribbonParticle.frag");
        this.poolShader = await loadShader_url(gl, "textureDebug", "./flow/shaders/showPool.vert", "./flow/shaders/showPool.frag");
        this.textureShader = await loadShader_url(gl, "textureDebug", "./flow/shaders/texture.vert", "./flow/shaders/texture.frag");    
