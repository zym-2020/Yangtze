...
export default defineComponent({
  ...
  setup(props) {
    ...
    const avatarUrl = computed(() => {
      return (props.fileMeta as any).avatar === '' ? 'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png' : 'http://172.21.213.244:8002' + (props.fileMeta as any).avatar
    })
    ...
    const avatar = computed(() => {
      if (
        ...
        return "http://172.21.213.244:8002" + (props.fileInfo as any).avatar;
      }
