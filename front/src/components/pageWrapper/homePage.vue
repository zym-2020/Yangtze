<template #aa>
    <el-carousel height="94vh" direction="vertical" :autoplay="false" ref="carousel" trigger="click">
...
.el-carousel {
    ...
    .el-carousel__item:first-child {
      background: radial-gradient(circle at 14% 96%, rgba(0, 29, 158, 0.5) 0%, rgba(0, 6, 75, 0.9) 36%, rgba(0, 20, 85, 0.9) 100%), url("../../assets/homePage/ocean-bg.jpg");
      ...
      div#title {
        ...
        right: 8vw;
        line-height: 10vh;
        background-image: linear-gradient(30deg, #ffffff 0%, #d1f0ff 40%, #39d6fd 100%);
      ...
      div#usage-data {
        ...
        span {
          ...
          &:hover {
            background-image: linear-gradient(45deg, #c2ebff 0%, #99ddff 40%, #39d6fd 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            -webkit-animation: hue 60s infinite linear;
            cursor: pointer;
