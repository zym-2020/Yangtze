<template>
    <div class="header-main">
        <el-row>
            ...
            <el-col :span="2">
                <div class="grid-content amap">
                    一张图
                </div>
            </el-col>
            <el-col :span="2">
                <div class="grid-content analysis">
                    分析中心
                </div>
            </el-col>
            <el-col :span="2" :offset="9">
                <el-dropdown trigger="hover" @command="userNav">
                    <el-button type="primary" color="rgba(219, 219, 219, 0.5)" :dark="false">
                        <el-avatar :size="32" 
                            :src="
                                avatarUrl === ''
    ...
    .el-col {
        ...
        .grid-content {
            ...
            &:hover {
                ...
                &.index {
                    font-size: 2.5vh;
                    background-image: linear-gradient(45deg, #ffffff 0%, #9edcfc 40%, #39d6fd 100%);
                ...
                &.data {
                    font-size: 2.5vh;
                    background-image: linear-gradient(30deg, #fffcd2 0%, #fdfdd7 40%, #fff23a 100%);
                    -webkit-background-clip: text;
                    -webkit-text-fill-color: transparent;
                    -webkit-animation: hue 60s infinite linear;
                }
        ...
        &:last-child {
            ...
            .el-dropdown {
                ...
                .el-button {
                    ...
                    font-size: 2vh;
                    font-weight: 600;
                    background-image: linear-gradient(30deg, #ffffff 0%, #d5f1ff 40%, #b8f1ff 100%);
                    -webkit-background-clip: text;
                    -webkit-text-fill-color: transparent;
                    -webkit-animation: hue 60s infinite linear;
                    ...
                    &:hover {
                        border-width: 2px;
                        border-color: #b4b4b4;
                        background-image: linear-gradient(30deg, #ffffff 0%, #d5f1ff 40%, #39d6fd 100%);
                        -webkit-background-clip: text;
                        -webkit-text-fill-color: transparent;
                        -webkit-animation: hue 60s infinite linear;
                    }
